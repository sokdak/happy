 ...
 *
 * These look interchangeable and are not. Claude tops out at `max`, which Codex
 * has no equivalent for; Codex has `none` and `minimal` below Claude's floor.
 * Only `low | medium | high | xhigh` is common ground.
 *
