...
export const SessionView = React.memo((props: { id: string }) => {
    ...
    const mainContent = (
        <>
            ...
            {isLandscape && deviceType === 'phone' && Platform.OS !== 'web' && workflowBadge && (
    ...
    const composer = (
        <View onLayout={usesFloatingMobileDock ? handleComposerLayout : undefined}>
            <ChatComposer
                ...
                onAddImages={interactionEnabled && canUseAttachments ? addImages : undefined}
